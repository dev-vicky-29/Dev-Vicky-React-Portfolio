        ...
        <div className="">
            {EDUCATION.map((education, index) => (
                <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                    ...
                    <h6 className="mb-2 font-semibold">{education.class}  -   
                        <span className="text-sm text-purple-100">  {education.address}</span>
                    </h6>
                    <p className="mb-4 text-neutral-400 ">{education.marks}</p>
